...
arguments:
  - name: task-id
    ...
    required: true
allowed-tools: Bash(git:*), Bash(gh:*), Bash(bun:*), Bash(uv:*), Bash(npm:*), Bash(pnpm:*), Bash(yarn:*), Bash(cargo:*), Bash(go:*), Bash(python:*), Bash(python3:*), Bash(npx:*), Bash(node:*), Bash(make:*), Bash(wc:*), Bash(find:*), Bash(grep:*), Read, Glob, Grep, Edit, Write
---
