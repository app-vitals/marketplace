...
See `references/metrics-schema.md` for field derivation rules and backward compatibility.

This step is silent — no output. JSONL format: one JSON object per line, append-only.
