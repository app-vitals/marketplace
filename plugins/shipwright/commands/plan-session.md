...
1b. **Enrich with project docs**: Spawn the research agent via the Agent tool to load task-relevant project documentation. Pass the list of features/epics identified so far as the task description. Use the agent's output to inform the requirements analysis in step 2 — it surfaces existing architectural decisions, data models, API contracts, and constraints.
